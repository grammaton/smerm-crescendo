...
\fancyfoot[RO,LE]{\small w: \input{words.txt} • c: \input{char.txt} • p:~\thepage} % Custom footer text
...
\begin{figure}[htbp]
\centering
\includegraphics[width=.47\textwidth]{img/2020-01-29-16-18_page_1}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=.47\textwidth]{img/2020-01-30-17-37}
